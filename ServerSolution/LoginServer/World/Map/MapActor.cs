...
using static LoginServer.World.Map.MapActor;

namespace LoginServer.World.Map
{
        ...
        protected override void OnReceive(object message)
        {
            switch (message)
            {
                ...
                case MapActor.LeaveMapRequest leaveMapRequest:
                    {
                        // 유저 삭제
                        _logger.Debug($"MapActor.LeaveMapRequest userUid:{leaveMapRequest.UserSeq}");

                        _userList.Remove(leaveMapRequest.UserSeq);
                        break;
                    }
