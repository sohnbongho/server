...
void Session::RegisterRecv()
{
	...
	DWORD numOfBytes = 0;
	DWORD flasgs = 0;
	if(SOCKET_ERROR == ::WSARecv(_socket, &wsaBuf, 1, OUT &numOfBytes, OUT &flasgs, &_recvEvent, nullptr))
	{
		int32 errorCode = ::WSAGetLastError();
		if(errorCode != WSA_IO_PENDING)
		{
...
void Session::RegisterSend()
{
	...
	// Scatter-Gather(흩어져있는 데이터를 모아서 한방에 보낸다.)
